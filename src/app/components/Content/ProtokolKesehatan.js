            ...
            <div className={"bg-color-pallete-200 bg-cover bg-bottom"}>
                ...
                <div className={"container mx-auto pt-5"}>
                    <div className={"flex justify-center items-center content-center"}>
                        ...
                        <h1 className={"md:text-6xl text-center  text-5xl md:mb-0 font-medium text-black leading-relaxed font-serif"}>&nbsp;Protokol
                            Kesehatan&nbsp;</h1>
                    ...
                    <div className={"text-center px-10"}>
                        <p className={"leading-relaxed mb-10 text-black"}>Demi keamanan dan kenyamanan bersama, para
                            hadirin
                            undangan dihimbau untuk memenuhi beberapa peraturan berikut:
                        </p>
                        <div className={"flex flex-wrap mx-auto justify-center text-black w-full"}>
